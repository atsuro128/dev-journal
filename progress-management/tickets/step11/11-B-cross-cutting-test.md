...
1. `cross-cutting.md` の CRS-001〜CRS-016 / CRS-021〜CRS-054 / CRS-076〜CRS-088 を読み、既存の機能別テストでカバー済みのケースを洗い出す
...
| 区分 | 対象 | 結果 | メモ |
|------|------|------|------|
| テナント分離 | CRS-001〜CRS-016 | 未実施 | |
| RBAC | CRS-021〜CRS-054 | 未実施 | 機能別テストとの重複はクロス参照 |
| 非機能 | CRS-076〜CRS-088 | 未実施 | |

...
| ID | タイトル | 起票日 | 状態 |
|----|---------|-------|------|
| 129 | 新規追加モードの添付 UX を編集モードと同等にする（プレビュー対応 + ラベル整理） | 2026-04-21 | PR #87 レビュー PASS・マージ保留 |
| 130 | 明細詳細パネル閉じ時のスライドアニメーション中にレイアウトが切替 | 2026-04-21 | PR #86 レビュー PASS・マージ保留 |
| 131 | AttachmentUploader のクライアントサイドバリデーションエラー表示を整理 | 2026-04-21 | PR #85 レビュー PASS・マージ保留 |
| 132 | 明細保存成功後も beforeunload リスナが残存し、F5 でリロード確認ダイアログが表示される | 2026-04-21 | PR #88 レビュー PASS・マージ保留 |
| 133 | ログ・エラー出力の言語ポリシー整理（FE/BE 共通、日本語メッセージの棚卸しと削減） | 2026-04-21 | 別セッションで対応予定 |
| 134 | FE エラーハンドラのハードコード文言を err.message ベースに統一し、原因究明と再発防止を行う | 2026-04-21 | PR #84 レビュー PASS・マージ保留 |
| 135 | ReportDetailPage 削除/提出/承認等アクション系エラーが画面に表示されない | 2026-04-22 | 未着手、Step 11-D 前に解消予定 |
| 136 | 明細編集の変更破棄ダイアログが ConfirmDialog 未使用で UI 不統一 | 2026-04-22 | 未着手 |
| 137 | スマホ幅でレポート一覧・明細一覧ページがページ全体横スクロール | 2026-04-22 | 未着手 |
| 138 | スマホ幅でレポート作成フォームが横幅に収まらない | 2026-04-22 | 未着手 |
| 139 | レポート一覧が ReportListTable / StatusChip を使わず status 英語生値を露出（SCR-RPT-001 実装乖離） | 2026-04-22 | 未着手 |

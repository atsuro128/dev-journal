...
| 11-E | デプロイ・スモークテスト | platform-builder | 11-D | 作業中（2026-05-13: Phase 0 + Phase 1 完了 / 2026-05-18-19: Phase 2 + Phase 3 完了、26 リソース AWS apply 済み、ALB DNS `expense-saas-portfolio-alb-290554356.ap-northeast-1.elb.amazonaws.com` 取得、副次 #180 / #181 起票。Phase 4-7 USER 主導待ち） | `tickets/step11/11-E-deploy.md` |
...
| 181 | RDS backup_retention_period が Free Tier 制約により NFR-AVAIL-003 から逸脱（7 日 → 1 日） | 2026-05-19 | 起票のみ（post-MVP。Phase 3 apply で FreeTierRestrictionError、rds.tf を 1 日に修正して進行、有料化または NFR 緩和で post-MVP 解決） |

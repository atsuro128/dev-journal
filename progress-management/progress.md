...
| 10-B | レポート | backend-developer, frontend-developer | 10-A | レビュー待ち | `tickets/step10/10-B-report.md` |
| 10-C | ダッシュボード | backend-developer, frontend-developer | 10-A | レビュー待ち | `tickets/step10/10-C-dashboard.md` |
| 10-D | テナント管理 | backend-developer, frontend-developer | 10-A | レビュー待ち | `tickets/step10/10-D-tenant.md` |

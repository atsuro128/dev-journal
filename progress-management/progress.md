...
|----|--------|------|------|------|---------|
| 11-A | ローカル動作確認 | ユーザー + 指揮役 | Step 10 全完了、Step 8-11 完了 | 進行中（全 62 SMK 実施完了。第1バッチ 6 件 resolved、第2バッチ #157 マージ resolved、第3バッチ #154 SMK-006 #4 PASS で resolved 移動、#158/#162/#164 は SMK 再検証待ち、#160 は PR #114 リバートで未解決として再 open） | `tickets/step11/11-A-local-verification.md` |

...
|----|--------|------|------|------|---------|
| 11-A | ローカル動作確認 | ユーザー + 指揮役 | Step 10 全完了、Step 8-11 完了 | 進行中（全 62 SMK 実施完了。第1バッチ 6 件 resolved、第2バッチ #157 マージ resolved、第3バッチ #154/#158/#160/#162/#164 マージ済み、SMK 再検証待ち） | `tickets/step11/11-A-local-verification.md` |
...
| ID | タイトル | PR | コミット | 状態 |
|----|---------|-----|---------|------|
| 154 | AppDataGrid minHeight 中途半端（再対応） | #114 | 664efbc / 40ccb0f | pending-review（SMK-006 #4 再検証待ち） |
| 158 | Approver 処理済みレポート一覧（SCR-WFL-003 新規） | #111 | 722568e / 4d82545 / d1e8e37 / b4993f0 / 790e558 | pending-review（SMK-103〜105 検証待ち） |
| 160 | テナント全レポート一覧スマホ幅で横スクロール / 列省略改善（再対応） | #114 | 664efbc / 40ccb0f | pending-review（SMK-101 再検証待ち） |

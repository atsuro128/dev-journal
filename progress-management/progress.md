...
|----|--------|------|------|------|---------|
| 11-A | ローカル動作確認 | ユーザー + 指揮役 | Step 10 全完了、Step 8-11 完了 | 進行中（全 62 SMK 実施完了。第1バッチ MVP 対応 8 件マージ済み、SMK 再検証待ち。残未対応 #157/#158） | `tickets/step11/11-A-local-verification.md` |
...
| 157 | ダッシュボードの月別合計テーブルと直近レポート一覧の境界が不明瞭 | 2026-04-28 | 起票のみ（第2バッチ候補） |
| 158 | Approver が過去に承認/却下したレポートを UI から探す動線がない（API 対応済み、UI 未対応） | 2026-04-28 | 起票のみ（要設計改訂） |

### pending-review issue（第1バッチ MVP 対応分、SMK 再検証待ち）
| ID | タイトル | PR | コミット | 状態 |
|----|---------|-----|---------|------|
| 152 | ダッシュボード「承認待ち」カード右上の Badge dot の意図伝達が不十分 | #108 | 6916ed0 / d3c201a | pending-review（SMK-006 再検証待ち） |
| 153 | ダッシュボード「承認待ち」カードの見た目幅が他カードより狭く描画される | #108 | 6916ed0（副次解消） | pending-review（SMK-006 再検証待ち） |
| 154 | レポート一覧の空状態メッセージが DataGrid 高さ不足で表示されない | #107 | be95274 / 255d801 | pending-review（SMK-006 副次再検証待ち） |
| 155 | 一覧テーブル末尾の ChevronRight アイコンが画面間で不整合 | #107 | be95274 / 255d801 | pending-review（SMK-011 副次再検証待ち） |
| 156 | ワークフロー確認ダイアログ閉じる際に「支払完了」メッセージが一瞬ちらつく | #109 | 683c076 / adc5017 / 0f23fc0 / de49d82 / d2a90f8 | pending-review（SMK-011 再検証待ち） |
| 159 | 却下確認ダイアログの未入力バリデーションエラー文言が表示されない | #109 | 0f23fc0 / 5120cf9 / c8167d0 / d2a90f8 | pending-review（SMK-096 再検証待ち） |
| 160 | テナント全レポート一覧（DataGrid）スマホ幅で列幅省略により内容が読めない | #107 | be95274 / fb09eb4 / 255d801 | pending-review（SMK-101 再検証待ち） |
| 161 | テナント情報画面で MUI Card 未使用、設計書 admin-tenant.md §5 と乖離 | #106 | 4225877 | pending-review（SMK-102 再検証待ち） |

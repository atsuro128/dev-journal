...
| AppPaginationFooter 共通 UI 単体テスト（issue #147） | APF-001〜APF-007 | 7 |
| AppDataGrid 共通 UI 単体テスト（issue #147 再オープン slots 合成挙動検証） | ADG-001〜ADG-004 | 4 |
| **FE 合計** | **RPT-FE-001〜RPT-FE-116, RPT-FE-090-A, RPT-FE-108-A, RPT-FE-109-A, ADT-001〜ADT-007, ASL-001〜ASL-002, PSS-001〜PSS-005, APF-001〜APF-007, ADG-001〜ADG-004** | **144** |

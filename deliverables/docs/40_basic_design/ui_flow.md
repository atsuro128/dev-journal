...
```mermaid
graph TD
    SCR_AUTH_002[SCR-AUTH-002<br/>ログイン] --> SCR_DASH_001[SCR-DASH-001<br/>ダッシュボード<br/>下書き数/提出中数/却下数<br/>直近レポート一覧]

    SCR_DASH_001 --> SCR_RPT_001[SCR-RPT-001<br/>レポート一覧 - 自分]
    SCR_DASH_001 --> SCR_RPT_002[SCR-RPT-002<br/>レポート作成]

    SCR_RPT_001 --> SCR_RPT_004[SCR-RPT-004<br/>レポート詳細]
    SCR_RPT_002 -->|作成完了| SCR_RPT_004

    SCR_RPT_004 -->|編集| SCR_RPT_003[SCR-RPT-003<br/>レポート編集]
    SCR_RPT_003 -->|保存| SCR_RPT_004

    SCR_RPT_004 -->|明細追加/編集/削除| SCR_RPT_004
    SCR_RPT_004 -->|領収書添付/削除| SCR_RPT_004
    SCR_RPT_004 -->|提出| SCR_RPT_004
    SCR_RPT_004 -->|削除| SCR_RPT_001

    SCR_RPT_004 -->|再申請<br/>rejected時| SCR_RPT_002

    style SCR_DASH_001 fill:#e3f2fd
    style SCR_RPT_001 fill:#e3f2fd
    style SCR_RPT_002 fill:#e3f2fd
    style SCR_RPT_003 fill:#e3f2fd
    style SCR_RPT_004 fill:#e3f2fd
```
...
```mermaid
graph TD
    SCR_AUTH_002[SCR-AUTH-002<br/>ログイン] --> SCR_DASH_001[SCR-DASH-001<br/>ダッシュボード<br/>Member情報 + 承認待ち数<br/>月別支出サマリー]
    ...
    %% 承認者としての操作
    SCR_DASH_001 -->|承認待ちバッジ| SCR_WFL_001[SCR-WFL-001<br/>承認待ち一覧]
    SCR_WFL_001 --> SCR_RPT_004

    SCR_RPT_004 -->|承認<br/>コメント任意| SCR_RPT_004
    SCR_RPT_004 -->|却下<br/>理由入力| SCR_RPT_004

    style SCR_DASH_001 fill:#e8f5e9
    style SCR_WFL_001 fill:#e8f5e9
    style SCR_RPT_001 fill:#e3f2fd
    style SCR_RPT_002 fill:#e3f2fd
    style SCR_RPT_003 fill:#e3f2fd
    style SCR_RPT_004 fill:#e3f2fd
...
```mermaid
graph TD
    SCR_AUTH_002[SCR-AUTH-002<br/>ログイン] --> SCR_DASH_001[SCR-DASH-001<br/>ダッシュボード<br/>Member情報 + 支払待ち数<br/>月別支出サマリー]
    ...
    %% 経理担当としての操作（支払処理）
    SCR_DASH_001 -->|支払待ちバッジ| SCR_WFL_002[SCR-WFL-002<br/>支払待ち一覧]
    SCR_DASH_001 --> SCR_ADM_001[SCR-ADM-001<br/>テナント全レポート一覧]

    SCR_WFL_002 --> SCR_RPT_004
    SCR_ADM_001 --> SCR_RPT_004

    SCR_RPT_004 -->|支払完了<br/>自分のレポート以外| SCR_RPT_004

    style SCR_DASH_001 fill:#fce4ec
    style SCR_WFL_002 fill:#fce4ec
    style SCR_ADM_001 fill:#fce4ec
    style SCR_RPT_001 fill:#e3f2fd
    style SCR_RPT_002 fill:#e3f2fd
    style SCR_RPT_003 fill:#e3f2fd
    style SCR_RPT_004 fill:#e3f2fd
...
```mermaid
graph TD
    SCR_AUTH_002[SCR-AUTH-002<br/>ログイン] --> SCR_DASH_001[SCR-DASH-001<br/>ダッシュボード<br/>テナント全体の概況<br/>月別支出サマリー]

    %% 管理者としての操作
    SCR_DASH_001 --> SCR_ADM_001[SCR-ADM-001<br/>テナント全レポート一覧]
    SCR_DASH_001 --> SCR_ADM_002[SCR-ADM-002<br/>テナント情報]
    SCR_ADM_001 --> SCR_RPT_004[SCR-RPT-004<br/>レポート詳細]

    %% 申請者としての操作（自分のレポートのみ）
    SCR_DASH_001 --> SCR_RPT_001[SCR-RPT-001<br/>レポート一覧 - 自分]
    SCR_DASH_001 --> SCR_RPT_002[SCR-RPT-002<br/>レポート作成]
    SCR_RPT_001 --> SCR_RPT_004
    SCR_RPT_002 -->|作成完了| SCR_RPT_004
    ...
    style SCR_DASH_001 fill:#fff9c4
    style SCR_ADM_001 fill:#fff9c4
    style SCR_ADM_002 fill:#fff9c4
    style SCR_RPT_001 fill:#e3f2fd
    style SCR_RPT_002 fill:#e3f2fd
    style SCR_RPT_003 fill:#e3f2fd
    style SCR_RPT_004 fill:#e3f2fd
...
> Admin は他者のレポートは閲覧のみ。編集・承認・却下は不可（policies.md SS3.5 特殊ルール準拠）。

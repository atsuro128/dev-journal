...
| **Accounting の自己処理禁止** | Accounting が自分で作成したレポートの支払完了を記録できない | 内部統制（自己承認禁止と同パターン） |
| **Accounting の Member 操作** | Accounting は自分自身の経費レポートを作成・編集・提出できる（Member と同等の操作） | 実務上、経理担当も経費を立て替える |

...
|----|--------|------|------|------|--------|------|
| 3-1 | ADR: 技術スタック選定 | requirements.md（非機能要件） | adr/0001-tech-stack.md | - | Yes | 未着手 |
| 3-2 | ADR: マルチテナント方式 | domain_model.md | adr/0002-multi-tenant.md | - | Yes | 未着手 |
| 3-3 | ADR: RLS テナント分離 | domain_model.md, 3-2 の結論 | adr/0003-rls-tenant-isolation.md | 3-2 | No | 未着手 |
| 3-4 | ADR: インフラ選定 | requirements.md（非機能要件） | adr/0004-infra.md | - | Yes | 未着手 |
| 3-5 | アーキテクチャ設計 | 3-1〜3-4 の全 ADR | architecture.md | 3-1,3-2,3-3,3-4 | No | 未着手 |
...
**並列実行パターン**: 3-1, 3-2, 3-4 を同時実行 → 3-3 → 3-5 → 3-6
...
- **参考**: CLAUDE.md の技術スタック定義（既に決定済みだが、「なぜ」を記録する）
...
- **参考**: domain_model.md の Tenant / TenantMembership 構造

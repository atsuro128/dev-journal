...
|------|----------|----------------|----------|------------|
| 0 事前準備 | `deliverables/docs/00_goals.md`, `01_glossary.md`, `02_scope.md` | なし | `references/links.md` | `progress-management/issues/`, `review-findings/` |
| 1 要件定義 | `deliverables/docs/10_requirements/` | `deliverables/docs/00_goals.md`, `01_glossary.md`, `02_scope.md` | — | `progress-management/issues/`, `review-findings/` |
| 2 ドメイン設計 | `deliverables/docs/20_domain/` | `deliverables/docs/10_requirements/requirements.md`, `usecases.md`, `workflow.md`, `rbac.md` | — | `progress-management/issues/`, `review-findings/` |

...
| Phase 1 | JWT 鍵注入方式の統一 | ⬜ 未着手 | - | 別セッションで対応 |
| Phase 2 | 実装未参照 14 変数の整理 | ⬜ 未着手 | - | 別セッションで対応 |

Phase 1 / Phase 2 が残っているため、本 issue は `issues/open/` にとどまる。全 Phase 完了時に resolved 移動する。
